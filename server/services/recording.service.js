...
class CallRecording {
    ...
    async processAndUpload() {
        ...
        try {
            // Combine all audio buffers into single PCM file
            // For simplicity, we'll just concatenate all buffers in order
            // A more sophisticated approach would interleave user/AI audio
