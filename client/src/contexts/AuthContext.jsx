...
export function AuthProvider({ children }) {
  ...
  useEffect(() => {
    ...
    const verifyToken = async () => {
      ...
      console.log('🔵 AUTH CONTEXT: Verifying token on mount', { hasToken: !!storedToken });
      ...
      try {
        ...
        if (res.data?.valid === true) {
          ...
          console.log('🔴 AUTH CONTEXT: Token invalid (valid !== true), clearing localStorage');
        ...
        if (mounted) {
          console.log('🔵 AUTH CONTEXT: Verification complete, setting loading=false');
          setLoading(false);
        }
      }
    };
  ...
  const logout = async () => {
    ...
    try {
      ...
      setToken(null);
      setRole(null);
      console.log('✅ AUTH CONTEXT: Logged out, cleared localStorage and state');
    }
  };
